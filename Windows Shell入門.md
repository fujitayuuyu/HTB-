...
> - OSバージョン情報
>
> dir によるファイル一覧の表示( 利用されているコマンドやファイルから、OSの大まかなバージョンはわかるはず)
> type等のファイルの内容表示による設定ファイルの参照(C:\Windows\System32\license.rtfのOSのライセンス情報から探してみたり)
> 
> ```
...
| 項目                          | ディレクトリ                                                                                         | コマンド                                      |
|-------------------------------|------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| **1. 32ビットアプリケーション** | `C:\Program Files (x86)`                                                                              | `dir "C:\Program Files (x86)" /s`             |
| **2. 64ビットアプリケーション** | `C:\Program Files`                                                                                    | `dir "C:\Program Files" /s`                   |
| **3. Windowsアプリ (UWP)**      | `C:\Program Files\WindowsApps`                                                                        | `dir "C:\Program Files\WindowsApps" /s`       |
| **4. スタートアップ (全ユーザー)**| `C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp`                                       | `dir "C:\ProgramData\...\StartUp" /s`         |
| **5. スタートアップ (ユーザー)** | `C:\Users\<ユーザー名>\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\StartUp`                | `dir "C:\Users\...\StartUp" /s`               |
| **6. サービス実行**      | `C:\Windows\System32`                                                                                 | `dir "C:\Windows\System32" /s`                |
| **7. インストールされているドライバー**       | `C:\Windows\System32\drivers`                                                                         | `dir "C:\Windows\System32\drivers" /s`        |
